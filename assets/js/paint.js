function configureListeners() {
    let image = document.getElementsByTagName('img')// select img elements  


     for (var i = 0; i < image.length; i++) {        
        // iterate over images and add mouseover event listeners      
        document.getElementById(image[i].id).addEventListener('mouseover', addOpacity)        
        document.getElementById(image[i].id).addEventListener('mouseout', removeOpacity)      
    } 
}
